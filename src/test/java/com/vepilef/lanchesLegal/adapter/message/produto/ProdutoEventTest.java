...
class ProdutoEventTest {
    ...
    void equalsTest(){
        ...
        Assertions.assertDoesNotThrow(()->produtoEvent.equals(produtoEvent2));
    }
    ...
    void hashCodeTest(){
        ...
        Assertions.assertDoesNotThrow(()->produtoEvent.hashCode());
    }
    ...
    void toStringTest(){
        ...
        Assertions.assertDoesNotThrow(()->produtoEvent.toString());
    }
}
