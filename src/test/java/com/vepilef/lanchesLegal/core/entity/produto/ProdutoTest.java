package com.vepilef.lanchesLegal.core.entity.produto;
...
class ProdutoTest {
    ...
    void equalsTest(){
        ...
        Assertions.assertDoesNotThrow(()->produto.equals(produto2));
    }
    ...
    void hashCodeTest(){
        ...
        Assertions.assertDoesNotThrow(()->produto.hashCode());
    }
